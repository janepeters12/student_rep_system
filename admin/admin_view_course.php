...
<header>
    <div class="container">
        <ul id="slide-out" class="sidenav sidenav-fixed blue-grey">
            ...
            <li><a href="admin_view_course.php" style="background-color: #2196F3" class="white-text center">View Courses</a></li>
...
<main>
    <div class="no-pad-top section">
        <div class="center">
            <h5 class="white-text red">
                ...
                if (isset($_POST['delete'])) {
                    $rid = $_POST['rid'];
                    $xtray_functions->delete_course($rid);
                }
                ?>
            </h5>
        ...
        <form method = "post" action = "admin_view_course.php">
        <table>
            <thead>
            <tr>
                <th>Name</th>
